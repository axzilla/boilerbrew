<script lang="ts">
	...
	import DashbardCard from '$lib/components/containers/dashbard-card.svelte';
</script>

<div class="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
	<DashbardCard title="Total Revenue" value="$45,231.90" subValue="+20% from last moth">
		<DollarSign slot="icon" class="h-4 w-4 text-muted-foreground" />
	</DashbardCard>
	<DashbardCard title="Subscriptions" value="+2350" subValue="+189.1% from last month">
		<Users slot="icon" class="h-4 w-4 text-muted-foreground" />
	</DashbardCard>
	<DashbardCard title="Sales" value="+2350" subValue="+19% from last month">
		<CreditCard slot="icon" class="h-4 w-4 text-muted-foreground" />
	</DashbardCard>
	<DashbardCard title="Active Now" value="+572" subValue="+201 since last hour">
